...
const Card = ({ 
  ...
  return (
    <div className={`rounded-lg p-3 bg-secondary/75 dark:bg-secondary shadow-sm border border-neutral/20 dark:border-neutral/30 ${getInteractiveStyles()} ${className}`}>
      {children}
    </div>
  );
};
